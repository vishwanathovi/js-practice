...
// Intially running the quotes function once

var randLen = Math.floor(Math.random()*quotes.length)

var randQuote = quotes[randLen].quoteText;
var randAuthor = quotes[randLen].quoteAuthor;

document.querySelector(".quote").textContent = randQuote;
document.querySelector(".author").textContent = randAuthor;


// Write your code here

document.addEventListener('keydown',quoteRefresh)
...
// Random background code & padding code required
